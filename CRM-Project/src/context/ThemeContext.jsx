...
import { dezThemeSet } from "./ThemeDemo.jsx";
...
const ThemeContextProvider = ({ children }) => {
  ...
  const changeSideBarLayout = (name) => {
    if (name.value === "horizontal") {
      if (sideBarStyle.value === "overlay") {
        ...
        setSideBarStyle({ value: "mini", label: "Mini" });
  ...
  const changeBackground = (name) => {
    ...
    setBackground(name);
    // localStorage.setItem("themeVersion", JSON.stringify(name));
    // {console.log(name,"sldkjfhlsdkfh")}
  };
  ...
  if (
    currentUrl.startsWith("https://ials.in") ||
    currentUrl.startsWith("https://stratos.nexgenov8.com/")
  ) {
    useEffect(() => {
      const body = document.querySelector("body");
      body.setAttribute("data-typography", "poppins");
      ...
      if (
        ...
        setBackground({ value: "light", label: "Light" });
      } else {
        body.setAttribute("data-theme-version", "dark");
        setBackground({ value: "dark", label: "Dark" });
      }
