  ...
  const staticSentData = [
    {
      ...
      content: "Here's the initial draft of our project proposal..."
    },
    {
      id: 302,
      subject: "Draft: Team Meeting Agenda",
      date: "2023-05-08T16:30:00",
      content: "Topics to discuss in the next team meeting..."
    },
  ];
                ...
                <div className="col-xl-3 col-lg-4">
                  <div className="email-left-box">
                    ...
                    <div className="mail-list rounded overflow-hidden mt-4 ">
                      ...
                      <Link to="/mails/compose" className="list-group-item">
