        ...
        <div className="col-sm-8 col-lg-10">
              ...
              <div className="row py-2">
                ...
                <div className="col-9 p-0">
                  <p className="font-size-10">
                    <span className="font-weight-bold">15226</span> (Air India),
                    Flight Class
          ...
          <div className="row px-1">
            <div className="col-12 col-lg-4">
              <div className="row py-2">
                <div className="col-3 p-0 d-flex flex-column align-items-center">
                  ...
                  <img
                    src="\public\global_assets\images\qoutation\takeoff.png"
                    alt=""
                    style={{ height: "20px",width: "20px" }}
                  />
                </div>
            ...
            <div className="col-12 col-lg-4">
              <div className="row py-2">
                <div className="col-3 p-0 d-flex flex-column align-items-center">
                  <p className="m-0 font-size-9 font-weight-bold">Restaurant</p>
                  <img
