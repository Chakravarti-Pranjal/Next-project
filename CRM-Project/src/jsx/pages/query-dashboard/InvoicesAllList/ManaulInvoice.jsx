...
const ManualInvoice = () => {
  ...
  useEffect(() => {
    if (isEditMode && state?.row) {
      ...
      console.log(state.row.InvoiceDetails?.ExcludeGstorNot, "GFHD&66");
  ...
  const handleChangeServiceCostFrom = (e, index) => {
    ...
    setFormValue((prev) => {
      ...
      updatedRow.TotalAmount = (effectiveAmount + tcsAmount + taxAmount).toFixed(2);
                ...
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayTaxRate: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="Tax">Display Tax Rate</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayGstNo: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="GST">Display GST No</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayCinNo: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="CIN">Display CIN No</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayPlaceOfSupply: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="Supply">Display Place of Supply</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayClientGstin: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="GSTIN">Display Agent/Client's GSTIN</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displaySacCode: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="SAC">Display SAC Code</label>
                  </div>
                </li>
                <li>
                  <div class="form-check check-sm d-flex align-items-center">
                    <input
                      ...
                      onChange={(e) => setDisplayOptions(prev => ({ ...prev, displayArnNo: e.target.checked }))}
                    />
                    <label className="fontSize11px m-0 ms-1 mt-1" for="ARN">Display ARN No</label>
                  </div>
                </li>
              </ul>
