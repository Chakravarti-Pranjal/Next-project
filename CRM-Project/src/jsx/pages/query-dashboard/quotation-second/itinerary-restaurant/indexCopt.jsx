...
const Restaurant = ({ Type }) => {
  ...
  const createFilteredFinalForm = () => {
    const finalFormData = restaurantFormValue?.map((form, idx) => {
      ...
      const mealPlan =
        restaurantMealForm[idx]?.map((form) => {
    ...
    const filteredForm = finalFormData?.filter((form) => form != null);
    dispatch(setRestaurantFinalForm(filteredForm));
    return filteredForm;
  };
  useEffect(() => {
