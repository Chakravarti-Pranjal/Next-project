...
const LocalEscortMonument = ({ Type, checkBoxes, headerDropdown }) => {
  ...
  const qoutationDataLocal = useMemo(
    () => qoutationData?.ExcortDays?.find((item) => item.Type === "Local"),
    [qoutationData]
  );
...
export default React.memo(LocalEscortMonument);
