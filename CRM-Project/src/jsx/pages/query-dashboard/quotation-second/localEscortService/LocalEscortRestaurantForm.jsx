...
const LocalEscortRestaurantForm = ({ Type }) => {
  ...
  useEffect(() => {
    if (qoutationDataLocal?.Days) {
      ...
      console.log(hasRestaurantService, "HASRESTAU654");
      if (hasRestaurantService) {
        ...
        console.log(initialFormValue, "INITIKDJ326");
  ...
  const handleFinalSave = async (mealInd, index) => {
    try {
          ...
          (mealType) => {
            ...
            return {
              ...
              MarkupTotalValue: mathRoundHelper(
                markupTotalValue?.toFixed(2) || 0
              ), // Fallback for undefined markupTotalValue
              TotalServiceCost: mathRoundHelper(
                totalServiceCost?.toFixed(2) || 0
              ), // Fallback for undefined totalServiceCost
            };
          }
        );
      ...
      console.log("FilteredFinalFormLOCAL:", filteredFinalForm);
...
export default React.memo(LocalEscortRestaurantForm);
