...
<<<<<<< HEAD
        console.log("servicesRoom",servicesRoom);
=======
        // console.log("servicesRoom", servicesRoom)
>>>>>>> sagar
...
<<<<<<< HEAD
        console.log("staticRoom",staticRoom);
...
>>>>>>> sagar
  ...
  },[qoutationData,headerDropdown?.MealPlan]);
  ...
  console.log(window.location.hostname,"JHU78");
  ...
  const getHotelRateApi = async (
    ...
    try {
      ...
      console.log(queryDataFromLocalStroage,"JJU7");

      if (hotel && companyId && destination && queryDataFromLocalStroage) {
        const { data } = await axiosOther.post("priceEditHotelRatesJson",{
          ...
          MealPlanId: queryDataFromLocalStroage?.MealPlan || "",
          CurrencyId: "",
          TariffTypeId: "",
          RoomTypeId: "",
          MarketTypeId: "",
          HotelCategoryId: queryDataFromLocalStroage?.Hotel?.HotelCategory,
          SupplierID: " ",
          PaxType: queryDataFromLocalStroage?.PaxInfo?.PaxType,
          ValidFrom: queryDataFromLocalStroage?.TravelDateInfo?.FromDate,
          ValidTo: queryDataFromLocalStroage?.TravelDateInfo?.ToDate,
          QueryId: "",
          QuatationNo: "",
        });
        if (data?.Status === 1 && data?.Data?.length > 0) {
          console.log("KJH76",data);
...
<<<<<<< HEAD
    console.log("indexindex946",index);
    console.log("overrnight",overnightList);
=======
    // console.log("indexindex946", index)
    // console.log("overrnight", overnightList)
>>>>>>> sagar
    ...
    setHotelFormValue((prevArr) => {
      ...
      newArr[index] = {
        ...newArr[index],
        ServiceId: hotelFormValue?.length - 1 === index ? " " : hotelNameId,
        OverNight: hotelFormValue?.length - 1 === index ? "9" : overnightId,
        RoomCategory: hotelFormValue?.length - 1 === index ? " " : roomCategoryId,
        MealPlan: headerDropdown?.MealPlan,
      };
      return newArr;
    });
...
<<<<<<< HEAD
      console.log("lisstSeeee",data,index);
=======
      // console.log("lisstSeeee", data, index)
>>>>>>> sagar
  ...
  useEffect(() => {
<<<<<<< HEAD
    console.log("its running on adding");
    hotelFormValue?.forEach((row,index) => {
      console.log("HotelLIststtsts",row,index);
=======
    // console.log("its running on adding")
    hotelFormValue?.forEach((row, index) => {
      // console.log("HotelLIststtsts", row, index)
...
<<<<<<< HEAD
  const handleHotelTableDecrement = (index,item) => {
    console.log("indexindex1132",index);
=======
  const handleHotelTableDecrement = (index, item) => {
    // console.log("indexindex1132", index)
>>>>>>> sagar
    // Safety check to avoid removing non-existing items
    if (
      index < 0 ||
...
=======
    console.log("hotelFOrmVallll", hotelFormValue?.filter((_, ind) => ind !== index))
>>>>>>> sagar
      ...
      (room) => {
        if (room?.RoomType != "DBL Room") {
          return {
            ...
            Markupvalue: room?.MarkupPercent,
            MarkupTotalValue: room?.Markup,
            TotalServiceCost: room?.RoomCost + room?.Markup,
...
>>>>>>> sagar
    const mealRates = calculatedRateDetails?.MealRates?.map((meal) => {
      ...
      return {
        ...
        Markupvalue: meal?.MarkupPercent,
        MarkupTotalValue: meal?.Markup,
        TotalServiceCost: meal?.MealCost + meal?.Markup,
      };
    });
                ...
                <table class="table table-bordered itinerary-table">
                  <thead>
                    <tr className="its-table">
                      <th
                        rowSpan={2}
                        className="py-1 align-middle text-start days-width-9"
                      >
                        Days
                      </th>
                      ...
                      {(qoutationData?.TourSummary?.PaxTypeName === "FIT" ||
                        qoutationData?.TourSummary?.PaxTypeName === "BOTH") && roomDetails &&
...
=======
                          ? roomDetails && roomDetails[0]?.map((room, index) => {
>>>>>>> sagar
                            return (
...
<<<<<<< HEAD
                              checked={mealDetails?.every((set) => {
                                const data = set.find((item) => item.MealTypeId === "1");
                                return data ? data.IsPrice === true : false;
                              })}
                              onChange={(e) => handleSupplementAllCheck("1",e)}
=======
                            // checked={checkIncludes === "Yes"}
                            // onChange={(e) =>
                            //   setCheckIncludes(
...
<<<<<<< HEAD
                              checked={mealDetails?.every((set) => {
                                const data = set.find((item) => item.MealTypeId === "2");
                                return data ? data.IsPrice === true : false;
                              })}
                              onChange={(e) => handleSupplementAllCheck("2",e)}
=======
>>>>>>> sagar
                            // checked={checkIncludes === "Yes"}
                            // onChange={(e) =>
...
<<<<<<< HEAD
                              checked={mealDetails?.every((set) => {
                                const data = set.find((item) => item.MealTypeId === "3");
                                return data ? data.IsPrice === true : false;
                              })}
                              onChange={(e) => handleSupplementAllCheck("3",e)}
=======
>>>>>>> sagar
                            // checked={checkIncludes === "Yes"}
                            // onChange={(e) =>
...
<<<<<<< HEAD
=======
                                            type="number"   // add only type name
>>>>>>> sagar
...
<<<<<<< HEAD
                                      type="text"
=======
                                      type="number"   // chnage type to number
>>>>>>> sagar
                    ...
                    <table class="table table-bordered itinerary-table">
                      <thead>
                        <tr className="its-table">
                          <th
                            rowSpan={2}
                            className="py-1 align-middle text-start"
                          >
                            Days
                          </th>
                          {(Type == "Local" || Type == "Foreigner") && (
