...
const Transport = ({
  ...
  useEffect(() => {
    if (qoutationData?.Days) {
      ...
      if (!allDayServicesEmpty) {
        ...
        console.log(vehicleTypeForm[0], "vehicleTypeForm[0]");
        ...
        setSelectedOptionsSecond(formattedVehicles);
        // END
  ...
  const handleChange = (selected) => {
    if (selectedOptionsSecond.length > 0) {
      setSelectedOptionsSecond([...selected]);
      return;
    }
  ...
  // Rishi Changes
  // console.log("selectedOptionsRishi", selectedOptionsSecond);
  console.log("selectedOptionsRishi", selectedOptionsSecond);
          ...
          >
            ...
            <div>
              <Select
                isMulti
                value={
                  selectedOptionsSecond.length > 0
                ...
                <table class="table table-bordered itinerary-table">
                  <thead>
                    <tr>
                      ...
                      {selectedOptionsSecond?.map((form, index) => {
                        return (
