...
const Activity = () => {
    ...
    const tableData = [
      {
          SR: 1,
          ActivityName: "Highlights of Chambal",
          Destination: "Agra",
          Validity: "15-05-2023 TO 31-05-2023",
          MarketType: "All",
          Supplier: "1589 Gen X Haut Monde (Sector15)",
          GSTSlab: "8%",
          ActivityCost: "INR 16200",
          MaxPax: 10,
          PerPaxCost: "INR 1620"
      },
      {
          SR: 2,
          ActivityName: "1h-Sound & Light Show, Agra",
          Destination: "Agra",
          Validity: "01-05-2022 TO 03-05-2022",
          MarketType: "General",
          Supplier: "Mohd Rizwan",
          GSTSlab: "0",
          ActivityCost: "INR 0",
          MaxPax: 1,
          PerPaxCost: "INR 0"
      ...
      {
          SR: 3,
          ActivityName: "1h-Visit Galta Ji",
          Destination: "Jaipur",
          Validity: "04-07-2022 TO 05-07-2022",
          MarketType: "General",
  ...
  const table_columns = [
    ...
    {
        name: "Supplier",
        selector: (row) => <span className="fs-12">{row.ActivityCost}</span>,
        sortable: true,
        wrap: true,
        minWidth: "100px",
    },
    ...
    {
        name: "Max Pax",
        selector: (row) => <span className="fs-12">{row.MaxPax}</span>,
        sortable: true,
        wrap: true,
        minWidth: "50px",
    },
    {
        name: "Per Pax Cost",
        selector: (row) => <span className="fs-12">{row.PerPaxCost}</span>,
        sortable: true,
        wrap: true,
        minWidth: "100px",
    }
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="row form-row-gap">
                                                ...
                                                <div className="col">
                                                    <DatePicker className="form-control form-control-sm z-[10000000]"  name="FromDate" dateFormat="yyyy-MM-dd" />
                                                </div>
                                                <div className="col">
