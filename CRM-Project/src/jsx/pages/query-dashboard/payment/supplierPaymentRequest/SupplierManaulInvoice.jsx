...
const SupplierManaulInvoice = ({ supplierData, totalAmount, handleInvoiceCloses }) => {
        ...
        invoiceDetails: [
          {
            ...
            Amount: totalAmount.toString(),        // overwrite Amount
          },
        ],
      }));
    }
...
export default SupplierManaulInvoice;
