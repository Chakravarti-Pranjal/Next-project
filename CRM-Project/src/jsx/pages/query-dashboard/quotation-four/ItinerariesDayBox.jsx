...
function ItinerariesDayBox({
  ...
  // Initialize selectedIcons for non-restaurant services
  useEffect(() => {
    const services = [
      "hotels",
      "monuments",
    ...
    let isInitializationNeeded = false;
    const newSelectedIcons = { ...selectedIcons };

    services.forEach((service) => {
      if (data[service] && data[service].length > 0) {
        let hasM = false;
        // Check if any item in the service already has "M"
        data[service].forEach((item) => {
          const key = `${data.Day}-${removeServiceId(item)}`;
          if (selectedIcons[key] === "M") {
            hasM = true;
          }
        });
        // Initialize only if no "M" is found
        data[service].forEach((item, index) => {
          const key = `${data.Day}-${removeServiceId(item)}`;
          if (!selectedIcons[key] && !hasM && index === 0) {
            isInitializationNeeded = true;
            newSelectedIcons[key] = "M";
            hasM = true; // Ensure only one "M" per service
          } else if (!selectedIcons[key]) {
            isInitializationNeeded = true;
            newSelectedIcons[key] = "S";
          }
        });
      }
    });
  ...
  }, [data, selectedIcons, setSelectedIcons]);

  // Initialize selectedRestaurantIcons for restaurant service
  useEffect(() => {
    if (data.restaurant && data.restaurant.length > 0) {
      let isInitializationNeeded = false;
      const newSelectedRestaurantIcons = { ...selectedRestaurantIcons };

      data.restaurant.forEach((item) => {
        const key = `${data.Day}-${removeServiceId(item)}`;
        if (!selectedRestaurantIcons[key]) {
          isInitializationNeeded = true;
          newSelectedRestaurantIcons[key] = ["Breakfast", "Lunch", "Dinner"];
        }
      });

      if (isInitializationNeeded) {
        setSelectedRestaurantIcons(newSelectedRestaurantIcons);
      }
    }
  }, [data.restaurant, selectedRestaurantIcons, setSelectedRestaurantIcons]);

  const handleIconSelect = (itemText, day, iconType, service) => {
    if (iconType === "M") {
      // When selecting "M", set all other items of the same service to "S"
      setSelectedIcons((prev) => {
        const newIcons = { ...prev };
        // Find all items for the same service and day
        if (data[service] && data[service].length > 0) {
          data[service].forEach((item) => {
            const key = `${day}-${removeServiceId(item)}`;
            newIcons[key] = item === itemText ? "M" : "S";
          });
        }
        return newIcons;
      });
    } else {
      // If selecting "S", just update the clicked item
      setSelectedIcons((prev) => ({
        ...prev,
        [`${day}-${removeServiceId(itemText)}`]: "S",
      }));
    }
  };
  ...
  return (
    <div ref={setNodeRef} className="sliderCard" style={style}>
      ...
      {(data.hotels || []).length > 0 && (
        <div className="border-bottom">
          <h6 className="mb-2 border-bottom px-3 d-flex align-items-center gap-2">
            <img src={HotelIcon} alt="HotelIcon" style={{ width: "14px" }} />{" "}
            Hotels
          </h6>
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "hotels")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "hotels")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "monuments")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "monuments")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
      ...
      {(data.guide || []).length > 0 && (
        <div className="border-bottom">
          <h6 className="mb-2 px-3 border-bottom d-flex align-items-center gap-2">
            <img src={GuideIcon} alt="GuideIcon" style={{ width: "14px" }} />{" "}
            Guide
          </h6>
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "guide")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "guide")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "activity")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "activity")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "transport")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "transport")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
      ...
      {(data.flight || []).length > 0 && (
        <div className="border-bottom">
          <h6 className="mb-2 px-3 border-bottom d-flex align-items-center gap-2">
            <img src={FlightIcon} alt="FlightIcon" style={{ width: "14px" }} />{" "}
            Flight
          </h6>
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "flight")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "flight")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
      ...
      {(data.train || []).length > 0 && (
        <div className="border-bottom">
          <h6 className="mb-2 px-3 border-bottom d-flex align-items-center gap-2">
            <img src={TrainIcon} alt="TrainIcon" style={{ width: "14px" }} />{" "}
            Train
          </h6>
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "train")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "train")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                ...
                {editMode ? (
                  <div className="d-flex gap-1">
                    <img
                      ...
                      alt="M"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "M", "additional")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
                    ...
                    <img
                      ...
                      alt="S"
                      onClick={() =>
                        handleIconSelect(item, data.Day, "S", "additional")
                      }
                      className="mt-1"
                      style={{
                        boxShadow:
