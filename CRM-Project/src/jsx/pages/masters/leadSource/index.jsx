...
import { leadSourceValidationSchema } from "../master_validation.js";
import { leadSourceInitialValue } from "../masters_initial_value.js";
...
const Language = () => {
  ...
  const [businessData, setBusinessData] = useState(leadSourceInitialValue);
...
const navigate = useNavigate();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await leadSourceValidationSchema.validate(
        { ...businessData },
        { abortEarly: false }
      );
      ...
      const { data } = await axiosOther.post("addupdatelead", {
        ...businessData,
      });
      if (data?.Status == 1) {
        getListDataToServer();
        setBusinessData(leadSourceInitialValue);
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmation) {
      try {
        const { data } = await axiosOther.post("deletelead", {
          id: id,
        });
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Add Lead Source</h4>
              <button
