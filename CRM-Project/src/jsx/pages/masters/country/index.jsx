...
import { countryInitialValue } from "../masters_initial_value.js";
...
const Country = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmation) {
      try {
        const { data } = await axiosOther.post("deletecountry", { id });
                    ...
                    <div className="col-12">
                      <div className="row form-row-gap">
                        ...
                        <div className="col-md-6 col-lg-2">
                          ...
                          <input
                            type="text"
                            className={`form-control form-control-sm ${validationErrors?.ShortName ? "is-invalid" : ""
                              }`}
                            name="ShortName"
