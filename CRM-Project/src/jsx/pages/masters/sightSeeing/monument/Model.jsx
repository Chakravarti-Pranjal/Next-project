...
const Model = ({ serviceimagelist, handleimageDelete, row, open, Dataview, getserviceimagelist, setopen, setDataview, isDataLoading }) => {
        ...
        <>
            ...
            <Modal show={open} onHide={() => setopen(false)} centered size="xl">
                <Modal.Header closeButton>
                    <Modal.Title>Monument Images List  ({(row?.DestinationName)}) Monument Images Dimension ( 318 * 543 )</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="row">
                        <div className="col-12  mb-3">
                            {/* <ImageContainer validateSize={true} targetWidth={371} targetHeight={413} /> */}
                            <ImageContainer validateSize={true} targetWidth={318} targetHeight={543} />
