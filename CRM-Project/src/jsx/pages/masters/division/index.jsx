...
import { divisionValidationSchema } from "../master_validation.js";
import { divisionInitialValue } from "../masters_initial_value.js";
...
const Language = () => {
  ...
  const [businessData, setBusinessData] = useState(divisionInitialValue);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await divisionValidationSchema.validate(
        { ...businessData },
        { abortEarly: false }
      );
      ...
      const { data } = await axiosOther.post("addupdatedivision", {
        ...businessData,
      });
      if (data?.Status == 1) {
        getListDataToServer();
        setBusinessData(divisionInitialValue);
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmation) {
      try {
        const { data } = await axiosOther.post("deletedivision", {
          id: id,
        });
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Add Division</h4>
              <button
