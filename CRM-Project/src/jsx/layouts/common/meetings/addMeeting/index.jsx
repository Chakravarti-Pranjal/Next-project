...
import { meetingAddIntitalValue } from "../../../../pages/masters/masters_initial_value.js";
import { meetingsValidationSchema } from "../../../../pages/masters/master_validation.js";
...
const AddMeeting = () => {
    const [formValue, setFormValue] = useState(meetingAddIntitalValue);
    ...
    useEffect(() => {
        if (state?.partner_payload) {
            ...
            setFormValue({
                ...
                BusinessType: state?.BusinessTypeId,
                ...
                MeetingOutcome: state?.MeetingOutcome,
            ...
            <div className="col-lg-12">
                <div className="card">
                    <div className="card-header py-3">
                        <h4 className="card-title">Add Meeting : {state?.
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="row form-row-gap">
                                            ...
                                            <div className="col-md-12 col-lg-12"><h4 className="card-title"> Meeting Information</h4></div>
                                            <div className="col-md-6 col-lg-3">
                                            ...
                                            <div className="col-md-6 col-lg-3">
                                                ...
                                                <select
                                                    ...
                                                    id="status"
                                                    className="form-control form-control-sm"
                                                    value={formValue?.MeetingOutcome}
                                                    onChange={handleFormChange}
                                                >
                                                    <option value="">Select</option>
