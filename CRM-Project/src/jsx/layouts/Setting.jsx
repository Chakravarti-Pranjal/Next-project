          ...
          <div className={`dlab-demo-panel ${demoToggle ? "show" : ""}`}>
            ...
            <div className="dlab-demo-inner">
                  ...
                  <div className="overlay-bx dlab-demo-bx demo-active">
                    ...
                    <div className="overlay-layer">
                      <Link
                        ...
                        data-theme="1"
                        className="btn dlab_theme_demo btn-secondary btn-sm mr-2"
                      >
                        Default
                      </Link>
                    </div>
              ...
              <div className="fs-12 pt-3">
                ...
                This theme switcher is not part of product. It is only for demo. you
                will get all guideline in documentation. please check
